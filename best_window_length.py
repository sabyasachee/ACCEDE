...
def best_window_length(t_array):
	...
	for t in t_array:
		...
		v_I = mutual_information(valence_labels, valence_matrices.T)
		a_I = mutual_information(arousal_labels, arousal_matrices.T)
		print v_I, a_I
		...
		if arousal_I is None or arousal_I < a_I:
			...
			arousal_t = t
	print "Done"
	return valence_t, arousal_t

best_window_length([1,2,6,7,8,9,10])
